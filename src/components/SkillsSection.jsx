...
const skills = [
    ...
    {name : "PHP", level : 100, category : "frontend"}, 
    ...
    {name : "Linux", level : 100, category : "tools"}, 
            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="">
                    {categories.map(( category, key ) => (
                        <button 
                            className={cn("px-5 py-2 rounded-full transition-colors duration-300 capitalize", activeCategory === category ? "bg-primary text-primary-foreground" : "bg-secundary/70 text-foreground hover:bd-secundary") } 
                            key={key}
